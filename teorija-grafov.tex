...
\section{Poti, cikli in dvodelnost}
	...
	\begin{lemma}
		...
		\begin{proof}
			Naj bosta $u,v \in V(G)$ in $u=x_0,x_1,\cdots,x_k=v$ je $uv$-sprehod. "Ce so vsa vozli"s"ca paroma razli"cna, je to iskana pot. Sicer se nek $x$ ponovi. Naj bo $x_i$ prvo tako vozli"s"ce, $x_j$ pa druga pojavitev $x_i$. Sprehod $x_0, \ldots, x_i, x_{j+1}, \ldots, x_k$ je kraj"si od originalnega, in ima manj ponovitev. "Ce je ta sprehod pot, je to iskana pot. Sicer ponavljamo postopek dokler ne najdemo iskane poti.
		\end{proof}
	\end{lemma}
