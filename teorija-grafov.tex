...
\begin{document}
	...
	\begin{lemma}[Lema o rokovanju]
		za vsak G velja $sum[v \in V(G)] (deg(v)) = 2*|E(G)|$
		\begin{proof}
			$I(G): v_i 1/0 e_j$ \\
	...
	\begin{definition}[Petersenov graf]
		...
		Op: Petersenov graf je nek bad boy ker pokvari veliko izrekov.
	\end{definition}
...
\section{Poti, cikli in dvodelnost}
	...
	\end{theorem}
	\begin{proof}
		Dokaz za oba se nahaja v magisterskem programu. Lp
	\end{proof}
	
	\begin{definition}[Povezavna povezanost $G$]
		je najmanjse stevilo povezav, ki jih moramo odstraniti, da pove"camo "stevilo komponent $G$.
	\end{definition}
